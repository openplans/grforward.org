...
},_updateMetric:function(a){var b=this._getRoundNum(a);this._mScale.style.width=this._getScaleWidth(b/a)+"px",this._mScale.innerHTML=1e3>b?b+" m":b/1e3+" km"},_updateImperial:function(a){var b,c,d,e=3.2808399*a,f=this._iScale;e>5280?(b=e/5280,c=this._getRoundNum(b),f.style.width=this._getScaleWidth(c/b)+"px",f.innerHTML=c+" mi"):(d=this._getRoundNum(e),f.style.width=this._getScaleWidth(d/e)+"px",f.innerHTML=d+" ft")},_getScaleWidth:function(a){return Math.round(this.options.maxWidth*a)-10},_getRoundNum:function(a){var b=Math.pow(10,(Math.floor(a)+"").length-1),c=a/b;return c=c>=10?10:c>=5?5:c>=3?3:c>=2?2:1,b*c}}),e.control.scale=function(a){return new e.Control.Scale(a)},e.Control.Layers=e.Control.extend({options:{collapsed:!0,position:"topright",autoZIndex:!0},initialize:function(a,b,c){e.setOptions(this,c),this._layers={},this._lastZIndex=0,this._handlingClick=!1;for(var d in a)this._addLayer(a[d],d);for(d in b)this._addLayer(b[d],d,!0)},onAdd:function(a){return this._initLayout(),this._update(),a.on("layeradd",this._onLayerChange,this).on("layerremove",this._onLayerChange,this),this._container},onRemove:function(a){a.off("layeradd",this._onLayerChange,this).off("layerremove",this._onLayerChange,this)},addBaseLayer:function(a,b){return this._addLayer(a,b),this._update(),this},addOverlay:function(a,b){return this._addLayer(a,b,!0),this._update(),this},removeLayer:function(a){var b=e.stamp(a);return delete this._layers[b],this._update(),this},_initLayout:function(){var a="leaflet-control-layers",b=this._container=e.DomUtil.create("div",a);b.setAttribute("aria-haspopup",!0),e.Browser.touch?e.DomEvent.on(b,"click",e.DomEvent.stopPropagation):e.DomEvent.disableClickPropagation(b).disableScrollPropagation(b);var c=this._form=e.DomUtil.create("form",a+"-list");if(this.options.collapsed){e.Browser.android||e.DomEvent.on(b,"mouseover",this._expand,this).on(b,"mouseout",this._collapse,this);var d=this._layersLink=e.DomUtil.create("a",a+"-toggle",b);d.href="#",d.title="Layers",e.Browser.touch?e.DomEvent.on(d,"click",e.DomEvent.stop).on(d,"click",this._expand,this):e.DomEvent.on(d,"focus",this._expand,this),e.DomEvent.on(c,"click",function(){setTimeout(e.bind(this._onInputClick,this),0)},this),this._map.on("click",this._collapse,this)}else this._expand();this._baseLayersList=e.DomUtil.create("div",a+"-base",c),this._separator=e.DomUtil.create("div",a+"-separator",c),this._overlaysList=e.DomUtil.create("div",a+"-overlays",c),b.appendChild(c)},_addLayer:function(a,b,c){var d=e.stamp(a);this._layers[d]={layer:a,name:b,overlay:c},this.options.autoZIndex&&a.setZIndex&&(this._lastZIndex++,a.setZIndex(this._lastZIndex))},_update:function(){if(this._container){this._baseLayersList.innerHTML="",this._overlaysList.innerHTML="";var a,b,c=!1,d=!1;for(a in this._layers)b=this._layers[a],this._addItem(b),d=d||b.overlay,c=c||!b.overlay;this._separator.style.display=d&&c?"":"none"}},_onLayerChange:function(a){var b=this._layers[e.stamp(a.layer)];if(b){this._handlingClick||this._update();var c=b.overlay?"layeradd"===a.type?"overlayadd":"overlayremove":"layeradd"===a.type?"baselayerchange":null;c&&this._map.fire(c,b)}},_createRadioElement:function(a,c){var d='<input type="radio" class="leaflet-control-layers-selector" name="'+a+'"';c&&(d+=' checked="checked"'),d+="/>";var e=b.createElement("div");return e.innerHTML=d,e.firstChild},_addItem:function(a){var c,d=b.createElement("label"),f=this._map.hasLayer(a.layer);a.overlay?(c=b.createElement("input"),c.type="checkbox",c.className="leaflet-control-layers-selector",c.defaultChecked=f):c=this._createRadioElement("leaflet-base-layers",f),c.layerId=e.stamp(a.layer),e.DomEvent.on(c,"click",this._onInputClick,this);var g=b.createElement("span");g.innerHTML=" "+a.name,d.appendChild(c),d.appendChild(g);var h=a.overlay?this._overlaysList:this._baseLayersList;return h.appendChild(d),d},_onInputClick:function(){var a,b,c,d=this._form.getElementsByTagName("input"),e=d.length;for(this._handlingClick=!0,a=0;e>a;a++)b=d[a],c=this._layers[b.layerId],b.checked&&!this._map.hasLayer(c.layer)?this._map.addLayer(c.layer):!b.checked&&this._map.hasLayer(c.layer)&&this._map.removeLayer(c.layer);this._handlingClick=!1,this._refocusOnMap()},_expand:function(){e.DomUtil.addClass(this._container,"leaflet-control-layers-expanded")},_collapse:function(){this._container.className=this._container.className.replace(" leaflet-control-layers-expanded","")}}),e.control.layers=function(a,b,c){return new e.Control.Layers(a,b,c)},e.PosAnimation=e.Class.extend({includes:e.Mixin.Events,run:function(a,b,c,d){this.stop(),this._el=a,this._inProgress=!0,this._newPos=b,this.fire("start"),a.style[e.DomUtil.TRANSITION]="all "+(c||.25)+"s cubic-bezier(0,0,"+(d||.5)+",1)",e.DomEvent.on(a,e.DomUtil.TRANSITION_END,this._onTransitionEnd,this),e.DomUtil.setPosition(a,b),e.Util.falseFn(a.offsetWidth),this._stepTimer=setInterval(e.bind(this._onStep,this),50)},stop:function(){this._inProgress&&(e.DomUtil.setPosition(this._el,this._getPos()),this._onTransitionEnd(),e.Util.falseFn(this._el.offsetWidth))},_onStep:function(){var a=this._getPos();return a?(this._el._leaflet_pos=a,void this.fire("step")):void this._onTransitionEnd()},_transformRe:/([-+]?(?:\d*\.)?\d+)\D*, ([-+]?(?:\d*\.)?\d+)\D*\)/,_getPos:function(){var b,c,d,f=this._el,g=a.getComputedStyle(f);if(e.Browser.any3d){if(d=g[e.DomUtil.TRANSFORM].match(this._transformRe),!d)return;b=parseFloat(d[1]),c=parseFloat(d[2])}else b=parseFloat(g.left),c=parseFloat(g.top);return new e.Point(b,c,!0)},_onTransitionEnd:function(){e.DomEvent.off(this._el,e.DomUtil.TRANSITION_END,this._onTransitionEnd,this),this._inProgress&&(this._inProgress=!1,this._el.style[e.DomUtil.TRANSITION]="",this._el._leaflet_pos=this._newPos,clearInterval(this._stepTimer),this.fire("step").fire("end"))}}),e.Map.include({setView:function(a,b,d){if(b=b===c?this._zoom:this._limitZoom(b),a=this._limitCenter(e.latLng(a),b,this.options.maxBounds),d=d||{},this._panAnim&&this._panAnim.stop(),this._loaded&&!d.reset&&d!==!0){d.animate!==c&&(d.zoom=e.extend({animate:d.animate},d.zoom),d.pan=e.extend({animate:d.animate},d.pan));var f=this._zoom!==b?this._tryAnimatedZoom&&this._tryAnimatedZoom(a,b,d.zoom):this._tryAnimatedPan(a,d.pan);if(f)return clearTimeout(this._sizeTimer),this}return this._resetView(a,b),this},panBy:function(a,b){if(a=e.point(a).round(),b=b||{},!a.x&&!a.y)return this;if(this._panAnim||(this._panAnim=new e.PosAnimation,this._panAnim.on({step:this._onPanTransitionStep,end:this._onPanTransitionEnd},this)),b.noMoveStart||this.fire("movestart"),b.animate!==!1){e.DomUtil.addClass(this._mapPane,"leaflet-pan-anim");var c=this._getMapPanePos().subtract(a);this._panAnim.run(this._mapPane,c,b.duration||.25,b.easeLinearity)}else this._rawPanBy(a),this.fire("move").fire("moveend");return this},_onPanTransitionStep:function(){this.fire("move")},_onPanTransitionEnd:function(){e.DomUtil.removeClass(this._mapPane,"leaflet-pan-anim"),this.fire("moveend")},_tryAnimatedPan:function(a,b){var c=this._getCenterOffset(a)._floor();return(b&&b.animate)===!0||this.getSize().contains(c)?(this.panBy(c,b),!0):!1}}),e.PosAnimation=e.DomUtil.TRANSITION?e.PosAnimation:e.PosAnimation.extend({run:function(a,b,c,d){this.stop(),this._el=a,this._inProgress=!0,this._duration=c||.25,this._easeOutPower=1/Math.max(d||.5,.2),this._startPos=e.DomUtil.getPosition(a),this._offset=b.subtract(this._startPos),this._startTime=+new Date,this.fire("start"),this._animate()},stop:function(){this._inProgress&&(this._step(),this._complete())},_animate:function(){this._animId=e.Util.requestAnimFrame(this._animate,this),this._step()},_step:function(){var a=+new Date-this._startTime,b=1e3*this._duration;b>a?this._runFrame(this._easeOut(a/b)):(this._runFrame(1),this._complete())},_runFrame:function(a){var b=this._startPos.add(this._offset.multiplyBy(a));e.DomUtil.setPosition(this._el,b),this.fire("step")},_complete:function(){e.Util.cancelAnimFrame(this._animId),this._inProgress=!1,this.fire("end")},_easeOut:function(a){return 1-Math.pow(1-a,this._easeOutPower)}}),e.Map.mergeOptions({zoomAnimation:!0,zoomAnimationThreshold:4}),e.DomUtil.TRANSITION&&e.Map.addInitHook(function(){this._zoomAnimated=this.options.zoomAnimation&&e.DomUtil.TRANSITION&&e.Browser.any3d&&!e.Browser.android23&&!e.Browser.mobileOpera,this._zoomAnimated&&e.DomEvent.on(this._mapPane,e.DomUtil.TRANSITION_END,this._catchTransitionEnd,this)}),e.Map.include(e.DomUtil.TRANSITION?{_catchTransitionEnd:function(a){this._animatingZoom&&a.propertyName.indexOf("transform")>=0&&this._onZoomTransitionEnd()},_nothingToAnimate:function(){return!this._container.getElementsByClassName("leaflet-zoom-animated").length},_tryAnimatedZoom:function(a,b,c){if(this._animatingZoom)return!0;if(c=c||{},!this._zoomAnimated||c.animate===!1||this._nothingToAnimate()||Math.abs(b-this._zoom)>this.options.zoomAnimationThreshold)return!1;var d=this.getZoomScale(b),e=this._getCenterOffset(a)._divideBy(1-1/d),f=this._getCenterLayerPoint()._add(e);return c.animate===!0||this.getSize().contains(e)?(this.fire("movestart").fire("zoomstart"),this._animateZoom(a,b,f,d,null,!0),!0):!1},_animateZoom:function(a,b,c,d,f,g,h){h||(this._animatingZoom=!0),e.DomUtil.addClass(this._mapPane,"leaflet-zoom-anim"),this._animateToCenter=a,this._animateToZoom=b,e.Draggable&&(e.Draggable._disabled=!0),e.Util.requestAnimFrame(function(){this.fire("zoomanim",{center:a,zoom:b,origin:c,scale:d,delta:f,backwards:g})},this)},_onZoomTransitionEnd:function(){this._animatingZoom=!1,e.DomUtil.removeClass(this._mapPane,"leaflet-zoom-anim"),this._resetView(this._animateToCenter,this._animateToZoom,!0,!0),e.Draggable&&(e.Draggable._disabled=!1)}}:{}),e.TileLayer.include({_animateZoom:function(a){this._animating||(this._animating=!0,this._prepareBgBuffer());var b=this._bgBuffer,c=e.DomUtil.TRANSFORM,d=a.delta?e.DomUtil.getTranslateString(a.delta):b.style[c],f=e.DomUtil.getScaleString(a.scale,a.origin);b.style[c]=a.backwards?f+" "+d:d+" "+f},_endZoomAnim:function(){var a=this._tileContainer,b=this._bgBuffer;a.style.visibility="",a.parentNode.appendChild(a),e.Util.falseFn(b.offsetWidth),this._animating=!1},_clearBgBuffer:function(){var a=this._map;!a||a._animatingZoom||a.touchZoom._zooming||(this._bgBuffer.innerHTML="",this._bgBuffer.style[e.DomUtil.TRANSFORM]="")},_prepareBgBuffer:function(){var a=this._tileContainer,b=this._bgBuffer,c=this._getLoadedTilesPercentage(b),d=this._getLoadedTilesPercentage(a);return b&&c>.5&&.5>d?(a.style.visibility="hidden",void this._stopLoadingImages(a)):(b.style.visibility="hidden",b.style[e.DomUtil.TRANSFORM]="",this._tileContainer=b,b=this._bgBuffer=a,this._stopLoadingImages(b),void clearTimeout(this._clearBgBufferTimer))},_getLoadedTilesPercentage:function(a){var b,c,d=a.getElementsByTagName("img"),e=0;for(b=0,c=d.length;c>b;b++)d[b].complete&&e++;return e/c},_stopLoadingImages:function(a){var b,c,d,f=Array.prototype.slice.call(a.getElementsByTagName("img"));for(b=0,c=f.length;c>b;b++)d=f[b],d.complete||(d.onload=e.Util.falseFn,d.onerror=e.Util.falseFn,d.src=e.Util.emptyImageUrl,d.parentNode.removeChild(d))}}),e.Map.include({_defaultLocateOptions:{watch:!1,setView:!1,maxZoom:1/0,timeout:1e4,maximumAge:0,enableHighAccuracy:!1},locate:function(a){if(a=this._locateOptions=e.extend(this._defaultLocateOptions,a),!navigator.geolocation)return this._handleGeolocationError({code:0,message:"Geolocation not supported."}),this;var b=e.bind(this._handleGeolocationResponse,this),c=e.bind(this._handleGeolocationError,this);return a.watch?this._locationWatchId=navigator.geolocation.watchPosition(b,c,a):navigator.geolocation.getCurrentPosition(b,c,a),this},stopLocate:function(){return navigator.geolocation&&navigator.geolocation.clearWatch(this._locationWatchId),this._locateOptions&&(this._locateOptions.setView=!1),this},_handleGeolocationError:function(a){var b=a.code,c=a.message||(1===b?"permission denied":2===b?"position unavailable":"timeout");this._locateOptions.setView&&!this._loaded&&this.fitWorld(),this.fire("locationerror",{code:b,message:"Geolocation error: "+c+"."})},_handleGeolocationResponse:function(a){var b=a.coords.latitude,c=a.coords.longitude,d=new e.LatLng(b,c),f=180*a.coords.accuracy/40075017,g=f/Math.cos(e.LatLng.DEG_TO_RAD*b),h=e.latLngBounds([b-f,c-g],[b+f,c+g]),i=this._locateOptions;if(i.setView){var j=Math.min(this.getBoundsZoom(h),i.maxZoom);this.setView(d,j)}var k={latlng:d,bounds:h,timestamp:a.timestamp};for(var l in a.coords)"number"==typeof a.coords[l]&&(k[l]=a.coords[l]);this.fire("locationfound",k)}})}(window,document),window.L&&(window.L.Icon.Default.imagePath="/static/images"),function(a){"function"==typeof define&&define.amd?define(["jquery"],a):a(jQuery)}(function(a){if(!a.support.cors&&a.ajaxTransport&&window.XDomainRequest){var b=/^https?:\/\//i,c=/^get|post$/i,d=new RegExp("^"+location.protocol,"i");a.ajaxTransport("* text html xml json",function(e,f){if(e.crossDomain&&e.async&&c.test(e.type)&&b.test(e.url)&&d.test(e.url)){var g=null;return{send:function(b,c){var d="",h=(f.dataType||"").toLowerCase();g=new XDomainRequest,/^\d+$/.test(f.timeout)&&(g.timeout=f.timeout),g.ontimeout=function(){c(500,"timeout")},g.onload=function(){var b="Content-Length: "+g.responseText.length+"\r\nContent-Type: "+g.contentType,d={code:200,message:"success"},e={text:g.responseText};try{if("html"===h||/text\/html/i.test(g.contentType))e.html=g.responseText;else if("json"===h||"text"!==h&&/\/json/i.test(g.contentType))try{e.json=a.parseJSON(g.responseText)}catch(f){d.code=500,d.message="parseerror"}else if("xml"===h||"text"!==h&&/\/xml/i.test(g.contentType)){var i=new ActiveXObject("Microsoft.XMLDOM");i.async=!1;try{i.loadXML(g.responseText)}catch(f){i=void 0}if(!i||!i.documentElement||i.getElementsByTagName("parsererror").length)throw d.code=500,d.message="parseerror","Invalid XML: "+g.responseText;e.xml=i}}catch(j){throw j}finally{c(d.code,d.message,e,b)}},g.onprogress=function(){},g.onerror=function(){c(500,"error",{text:g.responseText})},f.data&&(d="string"===a.type(f.data)?f.data:a.param(f.data)),g.open(e.type,e.url),g.send(d)},abort:function(){g&&g.abort()}}}})}});var Gatekeeper={};!function(a){a.getInvalidFormEls=function(a){var b,c=$(a);return b=c.find("input, select, textarea").map(function(){var a,b,d=$(this);if(d.is(":visible"))if(this.validity){if(!this.validity.valid)return this}else if(d.removeClass("gatekeeper-invalid"),d.is('[type="checkbox"]')||d.is('[type="radio"]')?(a=c.find('[name="'+d.attr("name")+'"]'),b=a.is(":checked")):b=""!==(this.value||"").replace(/\s+/),this.hasAttribute("required")&&!b)return d.addClass("gatekeeper-invalid"),this})},a.validate=function(b){var c=a.getInvalidFormEls(b);return $(b).addClass("form-submitted"),c&&c.length>0?(c[0].focus(),c[0].select&&c[0].select(),!1):!0},a.onValidSubmit=function(b,c){return function(d){d.preventDefault(),a.validate(d.target)?b&&b.apply(this,arguments):c&&c.apply(this,arguments)}}}(Gatekeeper);var Shareabouts=Shareabouts||{};!function(NS,$){"use strict";NS.Util={patch:function(a,b,c){var d,e={};for(d in b)e[d]=a[d],a[d]=b[d];c();for(d in e)a[d]=e[d]},setPrettyDateLang:function(a){moment.lang(a)},getPrettyDateTime:function(a,b){return b?moment(a).format(b):moment(a).fromNow()},getAttrs:function(a){var b={},c=a.find('[type="checkbox"]:checked'),d=a.find('[type="checkbox"]:not(:checked)');return _.each(a.serializeArray(),function(a){b[a.name]=a.value}),c.each(function(a,c){c.name&&(b[c.name]=!0)}),d.each(function(a,c){c.name&&(b[c.name]=!1)}),b},isSupported:function(a){switch(a.browser.name){case"Chrome":case"Firefox":case"Safari":return!0;case"Microsoft Internet Explorer":var b=a.browser.version.indexOf("."),c=parseInt(a.browser.version.substr(0,b),10);if(c>7)return!0}return!1},fileInputSupported:function(){var a=document.createElement("input");return a.setAttribute("type","file"),a.disabled===!1},log:function(){var a=Array.prototype.slice.call(arguments,0);window.ga?this.analytics(a):NS.Util.console.log(a)},analytics:function(a){var b,c,d=a.shift(),e={"center-lat":"metric1","center-lng":"metric2",zoom:"metric3","panel-state":"dimension1"};switch(d.toLowerCase()){case"route":a=["send","pageview"].concat(a);break;case"user":a=["send","event"].concat(a);break;case"app":if(b=a.shift(),c=e[b],!c)return void this.console.error('No metrics or dimensions matching "'+b+'"');a=["set",c].concat(a);break;default:return}window.ga.apply(window,a)},console:window.console||{log:function(){},debug:function(){},info:function(){},warn:function(){},error:function(){}},getStyleRule:function(properties,rules){var t=function(a,b){for(var c in b)a=a.replace(new RegExp("{{"+c+"}}","g"),b[c]);return a},self=this,len,i,condition;for(i=0,len=rules.length;len>i;i++)if(condition=t(rules[i].condition,properties),eval(condition))return rules[i];return null},fixImageOrientation:function(a,b){var c=document.createElement("canvas"),d=c.getContext("2d"),e=a.width,f=a.height;switch(b){case 5:case 6:case 7:case 8:c.width=a.height,c.height=a.width;break;default:c.width=a.width,c.height=a.height}switch(b){case 1:break;case 2:d.translate(e,0),d.scale(-1,1);break;case 3:d.translate(e,f),d.rotate(Math.PI);break;case 4:d.translate(0,f),d.scale(1,-1);break;case 5:d.rotate(.5*Math.PI),d.scale(1,-1);break;case 6:d.rotate(.5*Math.PI),d.translate(0,-f);break;case 7:d.rotate(.5*Math.PI),d.translate(e,-f),d.scale(-1,1);break;case 8:d.rotate(-.5*Math.PI),d.translate(-e,0)}return d.drawImage(a,0,0),c},fileToCanvas:function(a,b,c){var d=new FileReader;d.onloadend=function(){var d=EXIF.readFromBinaryFile(new BinaryFile(this.result)),e=d.Orientation;loadImage(a,function(a){var c=NS.Util.fixImageOrientation(a,e);b(c)},c)},d.readAsBinaryString(a)},wrapHandler:function(a,b,c){var d=function(d){b.trigger(a,d),c&&c.apply(this,arguments)};return d},callWithRetries:function(a,b,c){var d=Array.prototype.slice.call(arguments,3),e=_.last(d),f=e.error,g=0;e||(e={},d.push(e)),e.error=function(){b>g?(g++,setTimeout(function(){a.apply(c,d)},100*g)):f&&f.apply(c,arguments)},a.apply(c,d)},uuid:function(){var a="xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(a){var b=16*Math.random()|0,c="x"==a?b:3&b|8;return c.toString(16)});return a},cookies:{save:function(a,b,c){var d;if(c){var e=new Date;e.setTime(e.getTime()+24*c*60*60*1e3),d="; expires="+e.toGMTString()}else d="";document.cookie=a+"="+b+d+"; path=/"},get:function(a){for(var b=a+"=",c=document.cookie.split(";"),d=0;d<c.length;d++){for(var e=c[d];" "===e.charAt(0);)e=e.substring(1,e.length);if(0===e.indexOf(b))return e.substring(b.length,e.length)}return null},destroy:function(a){this.save(a,"",-1)}},MapQuest:{geocode:function(a,b,c,d){if(!d)throw"You must provide a MapQuest key for geocoding to work.";c=c||{},c.dataType="jsonp",c.cache=!0,c.url="http://open.mapquestapi.com/geocoding/v1/address?key="+d+"&location="+a,b&&(c.url+="&boundingBox="+b.join(",")),$.ajax(c)},reverseGeocode:function(a,b,c){var d,e;if(!c)throw"You must provide a MapQuest key for geocoding to work.";d=a.lat||a[0],e=a.lng||a[1],b=b||{},b.dataType="jsonp",b.cache=!0,b.url="http://open.mapquestapi.com/geocoding/v1/reverse?key="+c+"&location="+d+","+e,$.ajax(b)}}}}(Shareabouts,jQuery);var Shareabouts=Shareabouts||{};!function(a){Handlebars.registerHelper("userToken",function(){return a.auth.getUserToken()}),Handlebars.registerHelper("hasUserSubmitted",function(b,c){var d=a.auth.getUserToken(),e=_.find(b,function(a){return a.user_token===d});return e?c.fn(this):c.inverse(this)})}(Shareabouts,jQuery,Shareabouts.Util.console);var Shareabouts=Shareabouts||{};!function(a,b){"use strict";var c=function(a,b,c){var d;return null===a||_.isObject(a)?(d=a,c=b):null!==a&&((d={})[a]=b),c=c?_.clone(c):{},{options:c,attrs:d}},d=function(a,b,c){return _.defaults(c||(c={}),{xhrFields:{withCredentials:!0}}),Backbone.sync.apply(this,[a,b,c])};a.PaginatedCollection=Backbone.Collection.extend({resultsAttr:"results",parse:function(a){return this.metadata=a.metadata,a[this.resultsAttr]},fetchNextPage:function(a,b){var c=this;this.metadata.next&&c.fetch({remove:!1,url:c.metadata.next,success:a,error:b})},fetchAllPages:function(a){var b,c,d,e,f,g,h=this,i=0,j=1;a=a||{},a.data=a.data||{},a.error&&(g=_.once(a.error)),b=function(b,g){var i,k=g[h.resultsAttr].length;if(j=Math.ceil(g.metadata.length/k),a.success&&(f=_.after(j,a.success)),g.metadata.next)for(i=2;j>=i;i++)h.fetch(_.defaults({remove:!1,data:_.defaults({page:i},a.data),complete:c,success:d,error:e},a));d.apply(this,arguments)},c=function(){i++,a.pageComplete&&a.pageComplete.apply(this,arguments),i===j&&a.complete&&a.complete.apply(this,arguments)},d=function(){a.pageSuccess&&a.pageSuccess.apply(this,arguments),f&&f.apply(this,arguments)},e=function(){a.pageError&&a.pageError.apply(this,arguments),g&&g.apply(this,arguments)},this.fetch(_.defaults({success:b,error:e,complete:c},a))}}),a.SubmissionModel=Backbone.Model.extend({sync:d}),a.SubmissionCollection=a.PaginatedCollection.extend({initialize:function(a,b){this.options=b},model:a.SubmissionModel,url:function(){var a=this.options.submissionType,b=this.options.placeModel&&this.options.placeModel.id;if(!a)throw new Error("submissionType option is required.");if(!b)throw new Error("Place model id is not defined. You must save the place before saving its "+a+".");return this.options.placeModel.url()+"/"+a},sync:d,comparator:"created_datetime"}),a.SnapshotModel=Backbone.Model.extend({sync:d,waitUntilReady:function(a){a=a||{};var c=this,d=50,e=c.get("url")+"."+(a.format||"json"),f=function(){b.ajax({url:e,data:a.data,type:"HEAD",success:function(){var b=Array.prototype.splice.call(arguments,0);a.success&&a.success.apply(this,[e].concat(b))},error:function(b){503===b.status?(5e3>d&&(d*=2),_.delay(f,d)):a.error&&a.error.apply(this,arguments)}})};f()}}),a.SnapshotCollection=Backbone.Collection.extend({url:"/api/places/snapshots",model:a.SnapshotModel}),a.PlaceModel=Backbone.Model.extend({initialize:function(){var b;this.submissionSets={},_.each(this.get("submission_sets"),function(b,c){var d=[];_.isArray(b)&&(d=b),this.submissionSets[c]=new a.SubmissionCollection(d,{submissionType:c,placeModel:this})},this),b=this.get("attachments")||[],this.attachmentCollection=new a.AttachmentCollection(b,{thingModel:this}),this.attachmentCollection.each(function(a){a.set({saved:!0})})},set:function(b,d,e){var f=c(b,d,e);return _.isArray(f.attrs.attachments)&&this.attachmentCollection&&!f.options.ignoreAttachments&&this.attachmentCollection.reset(f.attrs.attachments),_.each(f.attrs.submission_sets,function(a,b){this.submissionSets&&this.submissionSets[b]&&_.isArray(a)&&this.submissionSets[b].reset(a)},this),a.PlaceModel.__super__.set.call(this,f.attrs,f.options)},save:function(d,e,f){var g,h=this,i=c(d,e,f),j=i.attrs;f=i.options,this.isNew()?(g=f.success||b.noop,f.success=function(){h.saveAttachments(),g.apply(this,arguments)}):h.saveAttachments(),f.ignoreAttachments=!0,a.PlaceModel.__super__.save.call(this,j,f)},saveAttachments:function(){this.attachmentCollection.each(function(a){a.isNew()&&a.save()})},parse:function(a){var b=_.clone(a.properties);return b.geometry=_.clone(a.geometry),b},sync:function(a,b,c){var e;return("create"===a||"update"===a)&&(e={type:"Feature",geometry:b.get("geometry"),properties:_.omit(b.toJSON(),"geometry")},c.data=JSON.stringify(e),c.contentType="application/json"),d.apply(this,[a,b,c])},toGeoJSON:function(){return{type:"Feature",geometry:this.get("geometry"),properties:_.omit(this.toJSON(),"geometry")}},getSubmissionSetCollection:function(b){return this.submissionSets[b]=this.submissionSets[b]||new a.SubmissionCollection([],{submissionType:b,placeModel:this}),this.submissionSets[b]},getLoggingDetails:function(){return this.id}}),a.PlaceCollection=a.PaginatedCollection.extend({url:"/api/places",model:a.PlaceModel,resultsAttr:"features",fetchByIds:function(a,b){var c=_.result(this,"url");1===a.length?this.fetchById(a[0],b):(a=_.map(a,function(a){return encodeURIComponent(a)}),b=b?_.clone(b):{},b.url=c+("/"===c.charAt(c.length-1)?"":"/")+a.join(","),this.fetch(_.extend({remove:!1},b)))},fetchById:function(b,c){c=c?_.clone(c):{};var d=this,e=new a.PlaceModel,f=c.success;e.set("id",b),e.collection=d,c.success=function(){var a=Array.prototype.slice.call(arguments);d.add(e),f&&f.apply(this,a)},e.fetch(c)},sync:d}),a.AttachmentModel=Backbone.Model.extend({idAttribute:"name",initialize:function(a,b){this.options=b},isNew:function(){return this.get("saved")!==!0},save:function(a,b,d){var e=c(a,b,d),f=_.extend(this.attributes,e.attrs);return this._attachBlob(f.blob,f.name,e.options)},_attachBlob:function(c,d,e){var f=new FormData,g=this,h=a.Util.wrapHandler("progress",this,e.progress),i=b.ajaxSettings.xhr();f.append("file",c),f.append("name",d),e=e||{},b.ajax({url:this.collection.url(),type:"POST",xhr:function(){return i.upload&&i.upload.addEventListener("progress",h,!1),i},success:function(){var a=Array.prototype.slice.call(arguments);a[0].saved=!0,g.set({saved:!0}),e.success&&e.success.apply(this,a)},error:e.error,data:f,cache:!1,contentType:!1,processData:!1})},sync:d}),a.AttachmentCollection=Backbone.Collection.extend({model:a.AttachmentModel,initialize:function(a,b){this.options=b},url:function(){var a=this.options.thingModel,b=a.url();return b+"/attachments"},sync:d}),a.ActionCollection=a.PaginatedCollection.extend({url:"/api/actions",comparator:function(a,b){return a.get("created_datetime")>b.get("created_datetime")?-1:1},sync:d})}(Shareabouts,jQuery);var Shareabouts=Shareabouts||{};!function(a,b){"use strict";a.Auth=function(c){c=c||{},_.defaults(c,{apiRoot:"http://data.shareabouts.org/api/v2/",twitter:".shareabouts-auth-twitter-button",facebook:".shareabouts-auth-facebook-button",logout:".shareabouts-auth-logout-button",successPage:"/success.html",errorPage:"/error.html",anonToken:"shareabouts-user-token"});var d=this;this.options=c,this.login=function(a){d.authWindow=window.open(),d.authWindow.location.href=c.apiRoot+"users/login/"+a+"?next="+c.successPage},this.logout=function(){d.authWindow=window.open(),d.authWindow.location.href=c.apiRoot+"users/logout/?next="+c.successPage},this.bindEvents=function(){b(document).off("click",c.twitter),b(document).off("click",c.facebook),b(document).off("click",c.logout),b(document).on("click",c.twitter,function(a){a.preventDefault(),d.login("twitter")}),b(document).on("click",c.facebook,function(a){a.preventDefault(),d.login("facebook")}),b(document).on("click",c.logout,function(a){a.preventDefault(),d.logout()})},this.isAuthenticated=!1,this.getUserToken=function(a){return 0===arguments.length&&(a=this.userData),a?"user:"+a.username:this.getAnonymousUserToken()},this.getAnonymousUserToken=function(){var b=a.Util.cookies.get(c.anonToken);return b||(b=a.Util.uuid(),a.Util.cookies.save(c.anonToken,b,30)),b},this.initUser=function(){d.authWindow&&!d.authWindow.closed&&d.authWindow.close(),d.requestCurrentUserSession({complete:function(){d.bindEvents()}})},this.saveUserSession=function(b){b?(a.Util.cookies.save("user-id",b.id),a.Util.cookies.save("user-name",b.name),a.Util.cookies.save("user-username",b.username),a.Util.cookies.save("user-avatar-url",b.avatar_url)):this.clearUserSession()},this.getUserSession=function(){var b=a.Util.cookies.get("user-id");return b?{id:b,name:a.Util.cookies.get("user-name"),username:a.Util.cookies.get("user-username"),avatar_url:a.Util.cookies.get("user-avatar-url")}:void 0},this.clearUserSession=function(){a.Util.cookies.destroy("user-id"),a.Util.cookies.destroy("user-name"),a.Util.cookies.destroy("user-username"),a.Util.cookies.destroy("user-avatar-url")},this.requestCurrentUserSession=function(a){a=a||{};var c=a.success,e=a.error;b.ajax(_.extend({},a,{url:d.options.apiRoot+"users/current",xhrFields:{withCredentials:!0},crossDomain:!0,dataType:"jsonp",success:function(a){d.isAuthenticated=!!a,d.userData=a,d.saveUserSession(a),b(d).trigger("authsuccess",[a]),c&&c.apply(this,arguments)},error:function(){b(d).trigger("autherror"),e&&e.apply(this,arguments)}}))},this.requestNewUserSession=function(a,c,d){1===arguments.length&&(d=a),d=d||{};var e=this,f=d.error,g=d.complete,h=_.extend({},d);1===arguments.length?h.type="DELETE":(h.type="POST",h.data=JSON.stringify({username:a,password:c})),b.ajax(_.extend(h,{url:e.options.apiRoot+"users/current",contentType:"application/json",xhrFields:{withCredentials:!0},success:function(){e.requestCurrentUserSession(d)},error:function(){b(e).trigger("autherror"),f&&f.apply(this,arguments)},complete:function(a,b){g&&"success"===b||g.apply(this,arguments)}}))}}}(Shareabouts,jQuery,Shareabouts.Util.console);var Shareabouts=Shareabouts||{};!function(a){"use strict";a.PanelLayout=Backbone.View.extend({events:{"click .shareabouts-close-button":"handleCloseClick"},initialize:function(){this.$content=this.$(".shareabouts-panel-content")},showContent:function(b){this.currentView&&this.currentView.onClose&&this.currentView.onClose(),this.currentView=b,this.$content.html(b.render().el),this.$el.parent().addClass("panel-open").trigger("showpanel"),this.currentView.onShow&&this.currentView.onShow(),a.Util.log("APP","panel-state","open")},handleCloseClick:function(b){b.preventDefault(),this.$el.parent().removeClass("panel-open").trigger("closepanel"),a.Util.log("USER","panel","close-btn-click"),this.currentView.onClose&&(this.currentView.onClose(),a.Util.log("APP","panel-state","closed"))}})}(Shareabouts,jQuery,Shareabouts.Util.console);var Shareabouts=Shareabouts||{};!function(a,b){"use strict";a.PlaceSurveyItemView=Backbone.Marionette.ItemView.extend({tagName:"li",initialize:function(a){this.options=a},onClose:function(){b(this.options.umbrella).trigger("closeplacesurveyitem",[this])},onShow:function(){b(this.options.umbrella).trigger("showplacesurveyitem",[this])}}),a.PlaceSurveyView=Backbone.Marionette.CompositeView.extend({initialize:function(b){this.options=b,this.model||(this.model=new a.SubmissionModel),b.submitter&&this.model.set("submitter",b.submitter)},itemView:a.PlaceSurveyItemView,itemViewContainer:".survey-items",itemViewOptions:function(){return{template:this.options.surveyItemTemplate,umbrella:this.options.umbrella}},ui:{form:"form",submitButton:'[type="submit"], button'},events:{"submit @ui.form":"handleFormSubmit","input @ui.form":"handleChange","blur @ui.form":"handleChange"},handleChange:function(){var b=a.Util.getAttrs(this.ui.form);this.model.set(b)},handleFormSubmit:function(b){b.preventDefault();var c=this,d=a.Util.getAttrs(this.ui.form),e=this.model.get("submitter");a.Util.log("USER","place","submit-reply-btn-click",this.collection.options.placeModel.getLoggingDetails(),this.collection.size()),e&&this.model.unset("submitter"),this.ui.submitButton.prop("disabled",!0),this.$el.addClass("loading"),this.model.collection=this.collection,this.model.save(d,{crossDomain:!0,wait:!0,beforeSend:function(a){a.setRequestHeader("X-Shareabouts-Silent",!!c.options.silent)},success:function(){c.collection.add(c.model),c.ui.form.get(0).reset(),a.Util.log("USER","place","successfully-reply",c.collection.options.placeModel.getLoggingDetails())},error:function(){a.Util.log("USER","place","fail-to-reply",c.collection.options.placeModel.getLoggingDetails())},complete:function(){c.ui.submitButton.prop("disabled",!1),c.$el.removeClass("loading")}})},onClose:function(){b(this.options.umbrella).trigger("closeplacesurvey",[this])},onShow:function(){this.collection.fetchAllPages(),b(this.options.umbrella).trigger("showplacesurvey",[this])},setSubmitter:function(a){return this.model.set("submitter",a),this}})}(Shareabouts,jQuery,Shareabouts.Util.console);var Shareabouts=Shareabouts||{};!function(a,b){"use strict";a.PlaceSupportView=Backbone.Marionette.ItemView.extend({initialize:function(a){this.options=a||{},this.setSubmitter(a.submitter),this._initialEvents()},_initialEvents:function(){this.collection&&(this.listenTo(this.collection,"add",this.render),this.listenTo(this.collection,"remove",this.render),this.listenTo(this.collection,"reset",this.render))},ui:{form:"form",toggle:'[type="checkbox"]'},events:{"change @ui.toggle":"handleSupportChange"},handleSupportChange:function(b){var c,d=this,e=b.target.checked,f=this.getSubmitterSupport();
a.Util.log("USER","place","support-btn-click",d.collection.options.placeModel.getLoggingDetails(),d.collection.size()),e&&!f?(b.target.disabled=!0,c=a.Util.getAttrs(this.ui.form),c.user_token=d.userToken,this.collection.create(c,{crossDomain:!0,wait:!0,beforeSend:function(a){a.setRequestHeader("X-Shareabouts-Silent",!!d.options.silent)},success:function(){a.Util.log("USER","place","successfully-support",d.collection.options.placeModel.getLoggingDetails())},error:function(){d.getSubmitterSupport().destroy({crossDomain:!0}),alert("Oh dear. It looks like that didn't save."),a.Util.log("USER","place","fail-to-support",d.collection.options.placeModel.getLoggingDetails())}})):!e&&f&&(b.target.disabled=!0,f.destroy({crossDomain:!0,wait:!0,beforeSend:function(a){a.setRequestHeader("X-Shareabouts-Silent",!!d.options.silent)},success:function(){a.Util.log("USER","place","successfully-unsupport",d.collection.options.placeModel.getLoggingDetails())},error:function(){d.collection.add(f),alert("Oh dear. It looks like that didn't save."),a.Util.log("USER","place","fail-to-unsupport",d.collection.options.placeModel.getLoggingDetails())}}))},onClose:function(){b(this.options.umbrella).trigger("closeplacesupport",[this])},onShow:function(){this.collection.fetchAllPages(),b(this.options.umbrella).trigger("showplacesupport",[this])},getSubmitterSupport:function(a){var b=a||this.userToken;return this.collection.find(function(a){return a.get("user_token")===b})},setSubmitter:function(b){return this.userToken=a.auth.getUserToken(b),this}})}(Shareabouts,jQuery,Shareabouts.Util.console);var Shareabouts=Shareabouts||{};!function(a,b){"use strict";a.PlaceDetailView=Backbone.Marionette.Layout.extend({initialize:function(a){this.options=a},regions:{surveyRegion:".survey-region",supportRegion:".support-region"},onClose:function(){b(this.options.umbrella).trigger("closeplace",[this])},onShow:function(){b(this.options.umbrella).trigger("showplace",[this])},onRender:function(){this.options.surveyTemplate&&this.options.surveyItemTemplate&&this.surveyRegion.show(new a.PlaceSurveyView({collection:this.model.getSubmissionSetCollection("comments"),umbrella:this.options.umbrella,submitter:this.options.submitter,template:this.options.surveyTemplate,surveyItemTemplate:this.options.surveyItemTemplate})),this.options.supportTemplate&&this.supportRegion.show(new a.PlaceSupportView({collection:this.model.getSubmissionSetCollection("support"),umbrella:this.options.umbrella,submitter:this.options.submitter,template:this.options.supportTemplate}))}})}(Shareabouts,jQuery,Shareabouts.Util.console);var Shareabouts=Shareabouts||{};!function(a,b){"use strict";a.PlaceFormView=Backbone.Marionette.ItemView.extend({ui:{form:"form",submitButton:'[type="submit"], button'},events:{"submit @ui.form":"handleSubmit","input @ui.form":"handleChange","blur @ui.form":"handleChange"},initialize:function(b){this.options=b,this.model?this.setGeometry(this.model.get("geometry")):(this.model=new a.PlaceModel,this.model.collection=this.collection),b.submitter&&this.model.set("submitter",b.submitter)},handleChange:function(){var b=a.Util.getAttrs(this.ui.form);this.model.set(b)},handleSubmit:Gatekeeper.onValidSubmit(function(b){b.preventDefault();var c=this,d=a.Util.getAttrs(this.ui.form),e=this.model.get("submitter");a.Util.log("USER","new-place","submit-place-btn-click"),this.geometry&&(d.geometry=this.geometry,e&&this.model.unset("submitter"),this.ui.submitButton.prop("disabled",!0),this.$el.addClass("loading"),this.model.save(d,{wait:!0,crossDomain:!0,beforeSend:function(a,b){var d;a.setRequestHeader("X-Shareabouts-Silent",!!c.options.silent),c.options.include_invisible&&(d=-1!==b.url.indexOf("?")?"&":"?",b.url=b.url+d+"include_invisible"),a.withCredentials=!0},success:function(){c.collection.get(c.model.id)||c.collection.add(c.model),c.collection.trigger("create",c.model),c.options.success&&c.options.success.apply(c,arguments),a.Util.log("USER","new-place","successfully-add-place")},error:function(){c.options.error&&c.options.error.apply(c,arguments),a.Util.log("USER","new-place","fail-to-add-place")},complete:function(){c.ui.submitButton.prop("disabled",!1),c.$el.removeClass("loading")}}))},function(){}),setGeometry:function(a){return this.geometry=a,this.$el.addClass("shareabouts-geometry-set"),this},setSubmitter:function(a){return this.model.set("submitter",a),this},onClose:function(){b(this.options.umbrella).trigger("closeplaceform",[this])},onShow:function(){b(this.options.umbrella).trigger("showplaceform",[this])}})}(Shareabouts,jQuery,Shareabouts.Util.console);var Shareabouts=Shareabouts||{};!function(a,b){"use strict";var c=function(a,b){b.focusIcon?a.setIcon(L.icon(b.focusIcon)):b.focusStyle&&a.setStyle(b.focusStyle)},d=function(a,b){b.icon?a.setIcon(L.icon(b.icon)):b.style&&a.setStyle(b.style)};a.Map=function(e){var f,g,h,i,j=this,k={},l=b(e.el);for(!b.support.cors&&window.XDomainRequest&&(Backbone.emulateHTTP=!0),e=e||{},f='<div class="shareabouts-map-container"><div class="shareabouts-map"></div><div class="shareabouts-centerpoint"><span class="shadow"></span><span class="x"></span><span class="marker"></span></div></div><div class="shareabouts-legend-container"></div><div class="shareabouts-auth-container"></div><div class="shareabouts-add-button-container"></div><div class="shareabouts-panel"><span class="shareabouts-close-button">&times;</span><div class="shareabouts-panel-content"></div></div>',l.html(f),l.find(".shareabouts-legend-container").html(e.templates.legend?e.templates.legend():""),l.find(".shareabouts-add-button-container").html(e.templates["add-button"]()),i=new a.PanelLayout({el:l.find(".shareabouts-panel").get(0)}),this.map=L.map(l.find(".shareabouts-map").get(0),e.map),g=0;g<e.layers.length;++g)h=e.layers[g],L.tileLayer(h.url,h).addTo(this.map);this.placeCollection=new a.PlaceCollection,this.placeCollection.url=e.datasetUrl,this.geoJsonLayer=L.geoJson(null,{style:function(b){return a.Util.getStyleRule(b.properties,e.placeStyles).style},pointToLayer:function(b,c){var d=a.Util.getStyleRule(b.properties,e.placeStyles);return d.icon?L.marker(c,{icon:L.icon(d.icon)}):L.circleMarker(c,d.style)}}).on("layeradd",function(a){k[a.layer.feature.properties.id]=a.layer._leaflet_id}).addTo(this.map),this.map.on("dragend",function(b){var c=b.target.getCenter();j.placeFormView&&j.placeFormView.setGeometry({type:"Point",coordinates:[c.lng,c.lat]}),a.Util.log("USER","map","drag",j.map.getBounds().toBBoxString(),j.map.getZoom())}),this.map.on("moveend",function(){a.Util.log("APP","center-lat",j.map.getCenter().lat),a.Util.log("APP","center-lng",j.map.getCenter().lng)}),b(j.map.zoomControl._zoomInButton).click(function(){a.Util.log("USER","map","zoom",j.map.getBounds().toBBoxString(),j.map.getZoom())}),b(j.map.zoomControl._zoomOutButton).click(function(){a.Util.log("USER","map","zoom",j.map.getBounds().toBBoxString(),j.map.getZoom())}),j.map.on("zoomend",function(){a.Util.log("APP","zoom",j.map.getZoom())}),this.geoJsonLayer.on("click",function(b){var c=e.templates["place-detail"],d=b.layer.feature,f=j.placeCollection.get(d.properties.id);j.placeDetailView=new a.PlaceDetailView({template:c,model:f,umbrella:j,submitter:j.currentUser,surveyTemplate:e.templates["place-survey"],surveyItemTemplate:e.templates["place-survey-item"],supportTemplate:e.templates["place-support"]}),i.showContent(j.placeDetailView),a.Util.log("USER","map","place-marker-click",f.getLoggingDetails()),j.map.panTo(b.layer.getLatLng())}),b(this).on("showplace",function(b,d){var f=a.Util.getStyleRule(d.model.toJSON(),e.placeStyles),g=j.geoJsonLayer.getLayer(k[d.model.id]);c(g,f)}),b(this).on("closeplace",function(b,c){var f=a.Util.getStyleRule(c.model.toJSON(),e.placeStyles),g=j.geoJsonLayer.getLayer(k[c.model.id]);d(g,f)}),b(this).on("showplaceform",function(a,b){b.$el.parent().parent().parent().addClass("panel-form-open")}),b(this).on("closeplaceform",function(a,b){b.$el.parent().parent().parent().removeClass("panel-form-open")}),b(".shareabouts-panel").hover(function(){b("body").addClass("shareabouts-panel-hovered")},function(){b("body").removeClass("shareabouts-panel-hovered")}),l.on("click",".shareabouts-legend-button",function(a){a.preventDefault(),b(this).siblings(".shareabouts-legend").toggleClass("legend-open")}),l.on("click",".shareabouts-add-button",function(b){b.preventDefault();var c=e.templates["place-form"];j.placeFormView=new a.PlaceFormView({template:c,collection:j.placeCollection,umbrella:j,submitter:j.currentUser}),i.showContent(j.placeFormView),a.Util.log("USER","map","new-place-btn-click")}),l.on("showpanel closepanel",function(){j.map.invalidateSize(!0)}),this.setUser=function(a){var b;e.templates["auth-actions"]&&(b=e.templates["auth-actions"](a),l.find(".shareabouts-auth-container").html(b)),this.currentUser=a,this.placeFormView&&this.placeFormView.setSubmitter(a).render(),this.placeDetailView&&(this.placeDetailView.surveyRegion.currentView.setSubmitter(a).render(),this.placeDetailView.supportRegion.currentView.setSubmitter(a).render())},this.placeCollection.fetchAllPages({silent:!0,crossDomain:!0,pageSuccess:function(a,b){j.geoJsonLayer.addData(b)}}),this.placeCollection.on("add",function(b){j.geoJsonLayer.addData(b.toGeoJSON()),j.placeDetailView=new a.PlaceDetailView({template:e.templates["place-detail"],model:b,umbrella:j,submitter:j.currentUser,surveyTemplate:e.templates["place-survey"],surveyItemTemplate:e.templates["place-survey-item"],supportTemplate:e.templates["place-support"]}),i.showContent(j.placeDetailView)}),this.setUser(e.currentUser)}}(Shareabouts,jQuery,Shareabouts.Util.console);var Planbox=Planbox||{};!function(a,b){"use strict";a.Utils={pasteHtmlAtCaret:function(a,b){var c,d;if(window.getSelection){if(c=window.getSelection(),c.getRangeAt&&c.rangeCount){d=c.getRangeAt(0),d.deleteContents();var e=document.createElement("div");e.innerHTML=a;for(var f,g,h=document.createDocumentFragment();f=e.firstChild;)g=h.appendChild(f);var i=h.firstChild;d.insertNode(h),g&&(d=d.cloneRange(),d.setStartAfter(g),b?d.setStartBefore(i):d.collapse(!0),c.removeAllRanges(),c.addRange(d))}}else if((c=document.selection)&&"Control"!==c.type){var j=c.createRange();j.collapse(!0),c.createRange().pasteHTML(a),b&&(d=c.createRange(),d.setEndPoint("StartToStart",j),d.select())}},htmlEscape:function(a){return String(a).replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;").replace(/</g,"&lt;").replace(/>/g,"&gt;")},sortByInnerHTML:function(a){var c,d=[];return a=b(a),a.each(function(a,b){c=_.sortedIndex(d,b,function(a){return a.innerHTML}),d.splice(c,0,b)}),d},pathJoin:function(){var a,b,c="";for(a=0;a<arguments.length;++a)b=arguments[a],"/"===b[0]?c=b:c+=""===c||"/"===c[c.length-1]?b:"/"+b;return c},rootPathJoin:function(){var b=Array.prototype.slice.call(arguments,0);return b.unshift(a.bootstrapped.projectRootPath),a.Utils.pathJoin.apply(this,b)},guid:function(){var a=function(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)};return a()+a()+"-"+a()+"-"+a()+"-"+a()+"-"+a()+a()+a()},runHook:function(b,c,d,e){d=_.defaults(d||{},{startIndex:0,done:function(){},args:[]});var f,g,h=d.startIndex;if(h<_.size(b))do f=b[h],h+=1;while(f&&!f[c]);f?(g=d.args.concat([{nextHook:function(){a.Utils.runHook(b,c,_.extend({},d,{startIndex:h}))}}]),f[c].apply(f,g)):d.done.apply(e,d.args)},logEvents:function(c,d){b(c).on("click","[data-log-click]",function(){var c=b(this),e=d,f="click: "+(c.attr("data-ga-action")||c.text());a.Utils.log("USER",e,f)})},log:function(){var b=Array.prototype.slice.call(arguments,0);window.Intercom&&"support"===b[0].toLowerCase()?this.support(b):window.ga&&"support"!==b[0].toLowerCase()?this.analytics(b):a.Utils.console.log(b)},support:function(a){{var b;a[1]}a.length>2&&(b=a[2]),window.Intercom("trackEvent",a[1],a[2])},analytics:function(a){var b,c,d=a.shift(),e={"center-lat":"metric1","center-lng":"metric2",zoom:"metric3","panel-state":"dimension1"};switch(d.toLowerCase()){case"route":a=["send","pageview"].concat(a);break;case"user":a=["send","event"].concat(a);break;case"app":if(b=a.shift(),c=e[b],!c)return void this.console.error('No metrics or dimensions matching "'+b+'"');a=["set",c].concat(a);break;default:return}window.ga.apply(window,a)},console:window.console||{log:function(){},debug:function(){},info:function(){},warn:function(){},error:function(){}},merge:function(a,b){for(var c,d,e=0,f=0,g=a.length,h=b.length,i=[];g>e&&h>f;)c=a[e],d=b[f],d>c?(i.push(c),e++):c>d?(i.push(d),f++):(i.push(c),e++,f++);return g>e&&i.splice(i.length,0,a.slice(e)),h>f&&i.splice(i.length,0,b.slice(f)),i}}}(Planbox,jQuery);
